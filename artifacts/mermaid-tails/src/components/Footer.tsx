        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/mermaid.real.aquata/" target="_blank" rel="noopener noreferrer" data-testid="link-instagram" className="w-10 h-10 rounded-full border-2 flex items-center justify-center transition-all duration-300 hover:scale-110" style={{ borderColor: '#E1306C', color: '#E1306C', background: 'rgba(225,48,108,0.1)' }}>
                <Instagram size={20} />
              </a>
              <a href="https://www.youtube.com/channel/UCXeS0vlrfvEsvBBshqGFl8w" target="_blank" rel="noopener noreferrer" data-testid="link-youtube" className="w-10 h-10 rounded-full border-2 flex items-center justify-center transition-all duration-300 hover:scale-110" style={{ borderColor: '#FF0000', color: '#FF0000', background: 'rgba(255,0,0,0.1)' }}>
                <Youtube size={20} />
              </a>
              <a href="https://www.tiktok.com/@mermaid.aquata.sirene" target="_blank" rel="noopener noreferrer" data-testid="link-tiktok" className="w-10 h-10 rounded-full border-2 flex items-center justify-center transition-all duration-300 hover:scale-110" style={{ borderColor: '#69C9D0', color: '#69C9D0', background: 'rgba(105,201,208,0.1)' }}>
