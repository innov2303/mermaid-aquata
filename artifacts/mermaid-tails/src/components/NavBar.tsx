...
export function NavBar() {
  ...
  const isOverHero = scrollY < heroHeight * 0.75;
    ...
    <header
      ...
      style={
        isOverHero
          ...
          : {
              background: "rgba(220, 240, 252, 0.72)",
              backdropFilter: "blur(14px)",
              borderBottom: "1px solid rgba(0,180,220,0.20)",
              boxShadow: "0 2px 14px rgba(0,120,180,0.10)",
            }
      }
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between py-2">
          ...
          {navLinks.map((link) => {
            ...
            return (
              <Link
                ...
                style={{
                  color: isOverHero
                    ? isActive ? "#00e8ff" : "rgba(255,255,255,0.90)"
                    : isActive ? "#00a8cc" : "#0a2a4a",
                  fontWeight: isActive ? "600" : "400",
                  textShadow: isOverHero ? "0 1px 8px rgba(0,0,0,0.5)" : "none",
                }}
              >
                {link.label}
              </Link>
        ...
        <button
          ...
          style={{ color: isOverHero ? "rgba(255,255,255,0.90)" : "#0a2a4a" }}
