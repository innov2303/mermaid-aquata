...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen" style={{ backgroundColor: '#0a3a5c' }}>
      {/* Hero Section */}
      <section className="relative bg-[#040f28] overflow-hidden min-h-[calc(75vw+6rem)] md:min-h-screen">
        ...
        <div className="md:hidden absolute top-24 left-0 right-0 bottom-0 z-0 flex items-center justify-center" style={{ backgroundColor: '#040f28' }}>
          <img
            src="/images/hero.jpg"
            alt=""
            aria-hidden="true"
