        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {sirenes.map((sirene, i) => (
            <motion.div
              ...
              style={{ background: 'rgba(255,255,255,0.85)', border: '2px solid rgba(0,200,239,0.55)', boxShadow: '0 0 20px rgba(0,200,239,0.15)' }}
            >
              <Quote className="absolute top-6 right-6 w-12 h-12 rotate-180" style={{ color: 'rgba(0,200,239,0.2)' }} />
              ...
              <p className="italic font-light leading-relaxed" style={{ color: '#1a3d5c' }}>"{sirene.quote}"</p>
            </motion.div>
          ))}
        </div>
      </div>
