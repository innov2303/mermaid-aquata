                    ...
                    <div className="w-full max-w-lg flex flex-col items-center gap-6 text-center">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 w-full">
                        ...
                        <button
                          ...
                          style={{ background: 'rgba(0,200,239,0.15)', border: '1.5px solid rgba(0,200,239,0.6)', color: '#e0f5ff', boxShadow: '0 0 20px rgba(0,200,239,0.2)', transition: 'box-shadow 0.2s, filter 0.2s' }}
